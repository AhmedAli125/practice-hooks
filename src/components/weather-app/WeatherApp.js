...
function WeatherApp(props) {
    ...
    useEffect(() => {
        fetch(`https://api.openweathermap.org/data/2.5/weather?q=${props.cityName}&appid=${apiKey}`)
                    ...
                    <div className='container'>
                        ...
                        >
                            <li className = 'list-group-item m-2 p-2 fs-5'>
                                <i className="far fa-meh"></i>Feels Like : {feelsLike} Ferenheit
                            </li>
                            <li className = 'list-group-item m-2 p-2 fs-5' >
                                <i className="fas fa-thermometer-full"></i>Temperature : {temp} Ferenheit
                            </li>
                            <li className = 'list-group-item m-2 p-2 fs-5'>
